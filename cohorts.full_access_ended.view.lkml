...
view: cohorts_full_access_ended {
    extends: [cohorts_base_binary]
      ...
      sql: WITH
              ...
              WHERE event_name IN ('Subscription: Cancelled', 'Subscription: Full Access To Banned', 'Subscription: Full Access To No Access'
              ,'Subscription: Full Access To Provisional Locker', 'Subscription: Subscription Cancelled', 'Subscription: Full Access To Read Only')
              )
