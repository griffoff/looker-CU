  ...
  derived_table: {
    sql:with sales_orders1 as (
        ...
        from  STRATEGY.ADOPTION_PIVOT.SALES_UNITS_ADOPTIONPIVOT sal
          ...
          JOIN DEV.STRATEGY_SPRING_REVIEW_QUERIES.DM_PRODUCTS  prod ON (sal."PRODUCT_SKEY_BU") = (prod."PRODUCT_SKEY")
          ...
          JOIN STRATEGY.DW.DM_ENTITIES  ent ON (ent."ENTITY_NO") = (cust."ENTITY_NO")
