...
#   extension: required
  ...
  join: raw_olr_provisioned_product {
    fields: [current_product_count_sum, current_product_count_number, current_user_provisions, current_paid_user_provisions, current_user_ebook_provisions
            , current_paid_user_ebook_provisions, current_user_courseware_provisions,current_user_paid_courseware_provisions]
    view_label: "Provisioned Products"
