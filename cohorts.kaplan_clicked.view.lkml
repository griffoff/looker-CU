...
view: cohorts_kaplan_clicked {
  ...
  dimension: current {group_label: "Partners: Kaplan clicked"}

  dimension: minus_1 {group_label: "Partners: Kaplan clicked"}

  dimension: minus_2 {group_label: "Partners: Kaplan clicked"}

  dimension: minus_3 {group_label: "Partners: Kaplan clicked"}

  dimension: minus_4 {group_label: "Partners: Kaplan clicked"}
