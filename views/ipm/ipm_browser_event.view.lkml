...
view: ipm_browser_event_and_outcome {
  ...
  derived_table: {
    create_process: {
      ...
      CREATE OR REPLACE TRANSIENT TABLE looker_scratch.ipm_browser_event_and_outcome
      CLONE ${ipm_browser_event.SQL_TABLE_NAME}
      ;;

      sql_step:
      INSERT INTO looker_scratch.ipm_browser_event_and_outcome (message_id, event_action, event_category, user_platform, event_time, user_sso_guid)
