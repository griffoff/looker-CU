...
view: cohorts_full_access_50 {
  ...
  dimension: current { group_label: "Full Access 30% active days" description: "Student had a full active subscription for more than of 30% of the semester days (Terms: Spr Jan-Jun, Sum Jul, Fall Aug-Dec)" }

  dimension: minus_1 { group_label: "Full Access 30% active days" description: "Student had a full active subscription for more than of 30% of the semester days (Terms: Spr Jan-Jun, Sum Jul, Fall Aug-Dec)" }

  dimension: minus_2 { group_label: "Full Access 30% active days" description: "Student had a full active subscription for more than of 30% of the semester days (Terms: Spr Jan-Jun, Sum Jul, Fall Aug-Dec)" }

  dimension: minus_3 { group_label: "Full Access 30% active days" description: "Student had a full active subscription for more than of 30% of the semester days (Terms: Spr Jan-Jun, Sum Jul, Fall Aug-Dec)" }

  dimension: minus_4 { group_label: "Full Access 30% active days" description: "Student had a full active subscription for more than of 30% of the semester days (Terms: Spr Jan-Jun, Sum Jul, Fall Aug-Dec)" }
