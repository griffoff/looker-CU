...
view: cohorts_extended {
  ...
  dimension: current { group_label: "Subscription Extended" description:"Subscriptions extended in term (Terms: Spr Jan-Jun, Sum Jul, Fall Aug-Dec)"}

  dimension: minus_1 { group_label: "Subscription Extended" description:"Subscriptions extended in term (Terms: Spr Jan-Jun, Sum Jul, Fall Aug-Dec)" }

  dimension: minus_2 { group_label: "Subscription Extended" description:"Subscriptions extended in term (Terms: Spr Jan-Jun, Sum Jul, Fall Aug-Dec)" }

  dimension: minus_3 { group_label: "Subscription Extended" description:"Subscriptions extended in term (Terms: Spr Jan-Jun, Sum Jul, Fall Aug-Dec)" }

  dimension: minus_4 { group_label: "Subscription Extended" description:"Subscriptions extended in term (Terms: Spr Jan-Jun, Sum Jul, Fall Aug-Dec)" }
}
