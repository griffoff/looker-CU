...
view: cohorts_evernote_clicked {
  ...
  parameter: events_to_include {
    default_value: "Clicked on Evernote"
    hidden: yes
  }
...
# view: cohorts_evernote_clicked_old {
...
#                 ,CASE WHEN event_name = 'Clicked on Evernote' THEN 1 END AS clicked_career_center
...
#   dimension: current {group_label: "Partners: Evernote clicked"}

#   dimension: minus_1 {group_label: "Partners: Evernote clicked"}

#   dimension: minus_2 {group_label: "Partners: Evernote clicked"}

#   dimension: minus_3 {group_label: "Partners: Evernote clicked"}

#   dimension: minus_4 {group_label: "Partners: Evernote clicked"}
