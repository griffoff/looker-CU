...
view: cohorts_number_of_courseware_added_to_dash {
  ...
  derived_table: {
   ...
   ,number_of_ebooks_on_dash_pivoted AS
    ...
    PIVOT (SUM(number_of_courseware_on_dashboard) FOR terms_chron_order_desc IN (1, 2, 3, 4, 5))
    )
    SELECT
      user_sso_guid
  ...
  dimension: current { group_label: "# of courses added to dashboard" hidden: yes}

  dimension: minus_1 { group_label: "# of courses added to dashboard" hidden: yes}

  dimension: minus_2 { group_label: "# of courses added to dashboard" hidden: yes}

  dimension: minus_3 { group_label: "# of courses added to dashboard" hidden: yes}

  dimension: minus_4 { group_label: "# of courses added to dashboard" hidden: yes}

#   dimension: current_tiers_times {
#     group_label: "# of courses added to dashboard (tiers)"
#     hidden: no
#   }
#
